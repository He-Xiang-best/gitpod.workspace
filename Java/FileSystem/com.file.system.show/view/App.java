...
public class App extends JFrame{
    ...
    private view.FileDisplay fileDisplay; //
    private JToolBar toolBar; // 工具栏
    private JTextField urlBar; // 地址栏
    private view.FilesTree filesTree; // 文件树
    private JButton goButton; // 跳转
    public view.FileDisplay getFileDisplay() {
        return fileDisplay;
    }
    ...
    public void init(){
        ...
        // 文件 List 滑动块
        fileDisplay = new view.FileDisplay();
     ...
     * @return
     */
    public view.FilesTree getFilesTree() {
        return filesTree;
    }
    ...
    public static void main(String[] args) {
        ...
        FileModel fileModel = new FileModel(); // file model
        FileTreeModel treeModel = new FileTreeModel(); // file tree model
        FileController fileController = new FileController(app, fileModel, treeModel); // file controller
