...
public class Login extends JFrame implements ActionListener {
    ...
    private String basePath = System.getProperty("user.dir")+"\\src\\assets\\images\\";
    ...
    public Login() {
        ...
        // 设置背景图片
        Icon logo1 = new ImageIcon(basePath+"loginlogo.jpg");
        ...
        setLocation(scrnsize.width / 2 - this.getWidth() / 2, scrnsize.height
                / 2 - this.getHeight() / 2);
        Image img = toolkit.getImage(basePath+"appico.jpg");
        setIconImage(img);
