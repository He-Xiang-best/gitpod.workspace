...
public class Connection extends Thread {
    ...
    public void run() {
        try {// obj是Object类的对象
            ...
            if (obj.getClass().getName().equals("pojo.Customer")) {
                serverLogin();
            }
            if (obj.getClass().getName().equals("pojo.Register_Customer")) {
                serverRegiste();
            }
            if (obj.getClass().getName().equals("pojo.Message")) {
                serverMessage();
            }
            if (obj.getClass().getName().equals("pojo.Chat")) {
                serverChat();
            }
            if (obj.getClass().getName().equals("pojo.Exit")) {
                serverExit();
            }
        } catch (IOException e) {
