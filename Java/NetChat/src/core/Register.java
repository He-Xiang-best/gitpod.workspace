...
public class Register extends JFrame  implements ActionListener
{
    ...
    private String basePath = System.getProperty("user.dir")+"\\src\\assets\\";
    ...
    public Register(String ip)
    {
        ...
        //设置背景图片
        Icon logo = new ImageIcon(basePath+"images\\registerlogo.jpg");
        ...
        Image img=toolkit.getImage(basePath+"images\\appico.jpg");
        ...
        comboBox.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent arg0) {
                Icon logo = new ImageIcon(basePath+"face\\"+comboBox.getSelectedItem().toString()+".jpg");
        ...
        headLabel.setIcon(new ImageIcon(basePath+"face\\1.JPG"));
    ...
    //{
    //    new info.Register("127.0.0.1");
    //}

}  //class info.Register 结束
